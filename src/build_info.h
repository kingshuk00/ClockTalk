...
# define CLOCKTALK_VERSION_DEVEL x
#else
# define CLOCKTALK_VERSION_DEVEL 
#endif
#define CLOCKTALK_VERSION VERSION_STR(CLOCKTALK_VERSION_MAJOR, CLOCKTALK_VERSION_MINOR, CLOCKTALK_VERSION_PATCH)TOSTRING(CLOCKTALK_VERSION_DEVEL)
